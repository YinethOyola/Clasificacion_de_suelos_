...
def Carta_de_plasticidad(Limite_liquido,Indice_plasticidad):
  ...
  if path_MH.contains_point(point):
    print("El suelo esta clasificado como MH - Limo de alta plasticidad")
  elif path_CH.contains_point(point):
    print("El suelo esta clasificado como CH - Arcilla de alta plasticidad")
  elif path_CL.contains_point(point):
    print("El suelo esta clasificado como CL - Arcilla de baja plasticidad")
  elif path_CL_ML.contains_point(point):
    print("El suelo esta clasificado como CL-ML - Arcilla limosa de baja plasticidad")
  elif path_ML.contains_point(point):
    print("El suelo esta clasificado como ML - Limo de baja plasticidad")
  else:
    print("El suelo no tiene plasticidad")
